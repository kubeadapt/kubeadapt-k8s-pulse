...
* If you are a new contributor see: [Steps to Contribute](***REMOVED***steps-to-contribute)
...
* If you plan to do something more involved, first discuss your ideas
  on our [mailing list](https://groups.google.com/forum/?fromgroups***REMOVED***!forum/prometheus-developers).
...
* Relevant coding style guidelines are the [Go Code Review
  ...
  Environments](https://peter.bourgon.org/go-in-production/***REMOVED***formatting-and-style).

* Be sure to sign off on the [DCO](https://github.com/probot/dco***REMOVED***how-it-works)

***REMOVED******REMOVED*** Steps to Contribute
...
```
make test         ***REMOVED*** Make sure all the tests pass before you commit and push :)
```

We use [`golangci-lint`](https://github.com/golangci/golangci-lint) for linting the code. If it reports an issue and you think that the warning needs to be disregarded or is a false-positive, you can add a special comment `//nolint:linter1[,linter2,...]` before the offending line. Use this sparingly though, fixing the code to comply with the linter's recommendation is in general the preferred course of action.

***REMOVED******REMOVED*** Pull Request Checklist

* Branch from the master branch and, if needed, rebase to the current master branch before submitting your pull request. If it doesn't merge cleanly with master you may be asked to rebase your changes.

* Commits should be as small as possible, while ensuring that each commit is correct independently (i.e., each commit should compile and pass tests).

* If your patch is not getting reviewed or you need a specific person to review it, you can @-reply a reviewer asking for a review in the pull request or a comment, or you can ask for a review on IRC channel [***REMOVED***prometheus](https://webchat.freenode.net/?channels=***REMOVED***prometheus) on irc.freenode.net (for the easiest start, [join via Riot](https://riot.im/app/***REMOVED***/room/***REMOVED***prometheus:matrix.org)).

* Add tests relevant to the fixed bug or new feature.

***REMOVED******REMOVED*** Dependency management

The Prometheus project uses [Go modules](https://golang.org/cmd/go/***REMOVED***hdr-Modules__module_versions__and_more) to manage dependencies on external packages. This requires a working Go environment with version 1.12 or greater installed.
...
```bash
***REMOVED*** Pick the latest tagged release.
go get example.com/some/module/pkg

***REMOVED*** Pick a specific version.
...
```bash
***REMOVED*** The GO111MODULE variable can be omitted when the code isn't located in GOPATH.
...
***REMOVED******REMOVED*** API Implementation Guidelines

***REMOVED******REMOVED******REMOVED*** Naming and Documentation
...
***REMOVED******REMOVED******REMOVED*** Reading vs. Parsing
...
***REMOVED******REMOVED******REMOVED*** /proc and /sys filesystem I/O 
