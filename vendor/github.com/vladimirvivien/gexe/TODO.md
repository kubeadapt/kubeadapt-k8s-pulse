...
***REMOVED******REMOVED*** Top features/tasks
* [ ] Support and test on Windows platform (***REMOVED***27)
* [ ] Ability to map and access program flags (***REMOVED***20)
* [ ] Support for SSH/SCP
...
* [x] Piping/chaining OS exec commands (***REMOVED***29)
