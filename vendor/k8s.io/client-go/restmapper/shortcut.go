...
func (e shortcutExpander) KindFor(resource schema.GroupVersionResource) (schema.GroupVersionKind, error) {
	...
	// In the current wiring in k8s.io/cli-runtime/pkg/genericclioptions/config_flags.go***REMOVED***toRESTMapper,
	// we are using DeferredDiscoveryRESTMapper which on KindFor failure will clear the
	// cache and fetch all data from a cluster (see k8s.io/client-go/restmapper/discovery.go***REMOVED***KindFor).
