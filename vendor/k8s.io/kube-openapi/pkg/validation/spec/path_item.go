...
// A Path Item may be empty, due to [ACL constraints](http://goo.gl/8us55a***REMOVED***securityFiltering).
// The path itself is still exposed to the documentation viewer but they will
// not know which operations and parameters are available.
//
// For more information: http://goo.gl/8us55a***REMOVED***pathItemObject
