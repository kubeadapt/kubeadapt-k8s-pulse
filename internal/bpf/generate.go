...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go@v0.19.0 -cc clang -cflags "-O2 -g -Wall -Werror" -no-strip -target amd64,arm64 network ../../bpf/network_monitor.c -- -I../../bpf/headers
